...
[lsd](https://github.com/lsd-rs/lsd/releases), 1.2.0, lsd-v...-x86_64-pc-windows-msvc.zip
[lua-language-server](https://github.com/LuaLS/lua-language-server/releases/latest), 3.17.1, lua-language-server-...-win32-x64.zip
[neovim](https://github.com/neovim/neovim/releases/latest), 0.11.6, nvim-win64.msi
[powershell](https://github.com/PowerShell/PowerShell/releases), 7.5.4, automatically updated via winget.
[powershell-preview](https://github.com/PowerShell/PowerShell/releases), 7.6.0.101, automatically updated via winget.
[rg](https://github.com/BurntSushi/ripgrep/releases), 15.1.0, ripgrep-...-x86_64-pc-windows-msvc.zip
...
[wsl/rancher-desktop](https://rancherdesktop.io)
[wsl/rancher](https://dev.azure.com/softprocorp/RandD/_wiki/wikis/RandD-Wiki/3443/Docker-and-WSL2)
[yazi](https://github.com/sxyazi/yazi/releases), 26.1.22, yazi-x86_64-pc-windows-msvc.zip
[zig](https://ziglang.org/download/), 0.15.2, zig-x86_64-windows-...-.zip. Needed for nvim tree-sitter. Stick with the latest point release.
[zoxide](https://github.com/ajeetdsouza/zoxide/releases), 0.9.9, zoxide-...-x86_64-pc-windows-msvc.zip
~~[csharp_ls](https://github.com/razzmatazz/csharp-language-server), `dotnet tool install --global csharp-ls`~~
~~[starship](https://github.com/starship/starship/releases), starship-x86_64-pc-windows-msvc.msi (or maybe zip).~~
